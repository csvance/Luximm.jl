# SE-ResNet parity tests against timm reference outputs.
#
...
const VARIANTS_TO_TEST = Tuple(sort(collect(keys(Luximm.SERESNET_VARIANTS))))

@testset "SE-ResNet parity" begin
