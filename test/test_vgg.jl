# VGG parity tests against timm reference outputs.
#
...
# Deriving the list from VGG_VARIANTS keeps it in sync as new variants land
# in src/Models/VGG/Config.jl without a second edit here.
const VARIANTS_TO_TEST = Tuple(sort(collect(keys(Luximm.VGG_VARIANTS))))

@testset "VGG parity" begin
