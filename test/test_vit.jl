# Vision Transformer parity tests against timm reference outputs.
#
...
const VARIANTS_TO_TEST = Tuple(sort(collect(keys(Luximm.VIT_VARIANTS))))

@testset "ViT parity" begin
